...
var firstPerson = 'Garv'; // Replace with the actual name
var firstLocation = 'Ambala, India'; // Replace with the actual location

var secondPerson = 'Aahna'; // Replace with the actual name
var secondLocation = 'Ambala, India';
...
var timeLeaveStamp = new Date(2023, 10, 16);

//first day of renewed contact (year, month, day)
var timeMeetStamp = new Date(2024, 1, 25);
